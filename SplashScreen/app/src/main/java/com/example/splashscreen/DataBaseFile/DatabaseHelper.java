...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public String selectOneUserSendUserName(String email, String password) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " +
                Constants.TABLE_NAME + " WHERE " + Constants.KEY_EMAIL +
                " = '"+email.trim()+"'" +" and "+ KEY_PASSWORD + " = '"+password.trim()+"'"
                , null);
        cursor.moveToFirst();
    ...
    public int selectOneUserSendId(String email, String password) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + Constants.TABLE_NAME +
                " WHERE " + Constants.KEY_EMAIL + " = '"+email.trim()+"'" +" and "+ KEY_PASSWORD
                + " = '"+password.trim()+"'" , null);
        cursor.moveToFirst();
...
public void updatePassword(String email, String password){
    ...
    public boolean checkUserEmailForChangePass(String email){
        String[] columns = {
                KEY_ID
        };
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public boolean  isMasterEmpty() {
        ...
        boolean flag;
        String quString = "SELECT * FROM " + Constants.TABLE_NAME ;
